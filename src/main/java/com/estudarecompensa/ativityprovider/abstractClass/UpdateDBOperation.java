...
public class UpdateDBOperation<T, M> extends AbstractDBOperation {
    ...
    /**
     * Este método vai atualizar um registo na base de dados, na tabela das respostas 
     * às perguntas responddidas pelo utilizador
     * @return (JSONObject) result, com um status true ou false
     */
